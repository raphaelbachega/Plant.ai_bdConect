...
(
    ...
    senha varchar (40),
    gênero char (1),
    check (gênero = 'm' or gênero = 'f' or gênero = 'n'),
...
(null, 'Samuel Theo Erick Viana', '695391950-71', 'samueltheoerickviana@land.com.br', 'mj7N56Y0fZ', 'm', '1990-12-13', 'p', '45603-095', 241, 101),
(null, 'Nathan Thiago Hugo Caldeira', '433169351-18', 'hugocaldeira@dpauladecor.com.br', 'KU5igii0Hq', 'm', '1960-04-29', 'f', '65050-050', 287, 102),
(null, 'Roberto Carlos da Luz', '769145367-16', 'robertocarlosdaluz@semco.com.br', 'm9WJU72ag8', 'n', '1985-07-07', 'p', '69401-056', 745, 103);
drop table Cliente;
